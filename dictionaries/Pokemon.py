...
pokemon = {
    ...
    721: ["Volcanion", "Fire/Water"],    # Gen 6 ends here
    ...
    808: ["Meltan", "Steel"],
    809: ["Melmetal", "Steel"],    # Gen 7 ends here
    810: ["Grookey", "Grass"],
    811: ["Thwackey", "Grass"],
    812: ["Rillaboom", "Grass"],
    813: ["Scorbunny", "Fire"],
    ...
    905: ["Enamorus", "Fairy/Flying"],    # Gen 8 ends here
...
Alolan_Form = {
    "Rattata": [19, {"Alolan Form": "Dark/Normal"}],
    "Raticate": [20, {"Alolan Form": "Dark/Normal"}],
    "Raichu": [26, {"Alolan Form": "Electric/Psychic"}],
    "Sandshrew": [27, {"Alolan Form": "Ice/Steel"}],
    "Sandslash": [28, {"Alolan Form": "Ice/Steel"}],
    "Vulpix": [37, {"Alolan Form": "Ice"}],
    "Ninetales": [38, {"Alolan Form": "Ice/Fairy"}],
    "Diglett": [50, {"Alolan Form": "Ground/Steel"}],
    "Dugtrio": [51, {"Alolan Form": "Ground/Steel"}],
    "Meowth": [52, {"Alolan Form": "Dark"}],
    "Persian": [53, {"Alolan Form": "Dark"}],
    "Geodude": [74, {"Alolan Form": "Rock/Electric"}],
    "Graveler": [75, {"Alolan Form": "Rock/Electric"}],
    "Golem": [76, {"Alolan Form": "Rock/Electric"}],
    "Grimer": [88, {"Alolan Form": "Poison/Dark"}],
    "Muk": [89, {"Alolan Form": "Poison/Dark"}],
    "Exeggutor": [103, {"Alolan Form": "Grass/Dragon"}],
    "Marowak": [105, {"Alolan Form": "Fire/Ghost"}]
}
Galarian_Form = {
    "Meowth": [52, {"Galarian Form": "Steel"}],
    "Ponyta": [77, {"Galarian Form": "Psychic"}],
    "Rapidash": [78, {"Galarian Form": "Psychic/Fairy"}],
    "Slowpoke": [79, {"Galarian Form": "Psychic"}],
    "Slowbro": [80, {"Galarian Form": "Poison/Psychic"}],
    "Farfetch'd": [83, {"Galarian Form": "Fighting"}],
    "Weezing": [110, {"Galarian Form": "Poison/Fairy"}],
    "Mr. Mime": [122, {"Galarian Form": "Ice/Psychic"}],
    "Articuno": [144, {"Galarian Form": "Psychic/Flying"}],
    "Zapdos": [145, {"Galarian Form": "Fighting/Flying"}],
    "Moltres": [146, {"Galarian Form": "Dark/Flying"}],
    "Slowking": [199, {"Galarian Form": "Poison/Psychic"}],
    "Corsola": [222, {"Galarian Form": "Ghost"}],
    "Zigzagoon": [263, {"Galarian Form": "Dark/Normal"}],
    "Linoone": [264, {"Galarian Form": "Dark/Normal"}],
    "Darumaka": [554, {"Galarian Form": "Ice"}],
    "Darmanitan": [555, {"Galarian Standard Mode": "Fire",
                         "Galarian Zen Mode": "Fire/Psychic"}],
    "Yamask": [562, {"Galarian Form": "Ground/Ghost"}],
    "Stunfisk": [618, {"Galarian Form": "Ground/Steel"}],
}
Hisuian_Form = {
    "Growlithe": [58, {"Hisuian Form": "Fire/Rock"}],
    "Voltorb": [100, {"Hisuian Form": "Electric/Grass"}],
    "Electrode": [101, {"Hisuian Form": "Electric/Grass"}],
    "Arcanine": [59, {"Hisuian Form": "Fire/Rock"}],
    "Typhlosion": [157, {"Hisuian Form": "Fire/Ghost"}],
    "Qwilfish": [211, {"Hisuian Form": "Dark/Poison"}],
    "Sneasel": [215, {"Hisuian Form": "Fighting/Poison"}],
    "Samurott": [503, {"Hisuian Form": "Water/Dark"}],
    "Lilligant": [549, {"Hisuian Form": "Grass/Fighting"}],
    "Zorua": [570, {"Hisuian Form": "Normal/Ghost"}],
    "Zoroark": [571, {"Hisuian Form": "Normal/Ghost"}],
    "Braviary": [571, {"Hisuian Form": "Psychic/Flying"}],
    "Sliggoo": [705, {"Hisuian Form": "Steel/Dragon"}],
    "Goodra": [706, {"Hisuian Form": "Steel/Dragon"}],
    "Avalugg": [713, {"Hisuian Form": "Ice/Rock"}],
    "Decidueye": [724, {"Mega Audino": "Grass/Fighting"}],
}
Paldean_Form = {
    "Tauros": [128, {"Paldean Form (Combat Breed)": "Fighting",
                     "Paldean Form (Blaze Breed)": "Fighting/Fire",
                     "Paldean Form (Aqua Breed)": "Fighting/Water"}],
    "Wooper": [194, {"Paldean Form": "Poison/Ground"}],
}
Multiform = {    # Some don't change type between forms/modes
    "Charizard": [6, {"Mega Charizard X": "Fire/Dragon",
                      "Mega Charizard Y": "Fire/Flying"}],
    "Pinsir": [127, {"Mega Pinsir": "Bug/Flying"}],
    "Gyarados": [130, {"Mega Gyarados": "Water/Dark"}],
    "Mewtwo": [150, {"Mega Mewtwo X": "Psychic/Fighting",
                     "Mega Mewtwo Y": "Psychic"}],
    "Ampharos": [181, {"Mega Ampharos": "Electric/Dragon"}],
    "Sceptile": [254, {"Mega Sceptile": "Grass/Dragon"}],
    "Aggron": [306, {"Mega Aggron": "Steel"}],
    "Altaria": [334, {"Mega Altaria": "Dragon/Fairy"}],
    "Castform": [351, {"Sunny Form": "Fire",
                       "Rainy Form": "Water",
                       "Snowy Form": "Ice"}],
    "Groudon": [383, {"Primal Groudon": "Ground/Fire"}],
    "Wormadam": [413, {"Plant Cloak": "Bug/Grass",
                       "Sandy Cloak": "Bug/Ground",
                       "Trash Cloak": "Bug/Steel"}],
    "Lopunny": [428, {"Mega Lopunny": "Normal/Fighting"}],
    "Rotom": [479, {"Heat Rotom": "Electric/Fire",
                    "Wash Rotom": "Electric/Water",
                    "Frost Rotom": "Electric/Ice",
                    "Fan Rotom": "Electric/Flying",
                    "Mow Rotom": "Electric/Grass"}],
    "Shaymin": [492, {"Land Forme": "Grass",
                      "Sky Forme": "Grass/Flying"}],
    "Audino": [531, {"Mega Audino": "Normal/Fairy"}],
    "Darmanitan": [555, {"Standard Mode": "Fire",
                         "Zen Mode": "Fire/Psychic"}],
    "Meloetta": [648, {"Aria Forme": "Normal/Psychic",
                       "Pirouette Forme": "Normal/Fighting"}],
    "Hoopa": [720, {"Hoopa Confined": "Psychic/Ghost",
                    "Hoopa Unbound": "Psychic/Dark"}],
    "Oricorio": [741, {"Baile Style": "Fire/Flying",
                       "Pom-Pom Style": "Electric/Flying",
                       "Pa'u Style": "Psychic/Flying",
                       "Sensu Style": "Ghost/Flying"}],
    "Necrozma": [800, {"Dusk Mane Necrozma": "Psychic/Steel",
                       "Dawn Wings Necrozma": "Psychic/Ghost",
                       "Ultra Necrozma": "Psychic/Dragon"}],
    "Zacian": [888, {"Hero of Many Battles": "Fairy",
                     "Crowned Sword": "Fairy/Steel"}],
    "Zamazenta": [889, {"Hero of Many Battles": "Fighting",
                        "Crowned Sword": "Fighting/Steel"}],
    "Urshifu": [892, {"Single Strike Style": "Fighting/Dark",
                      "Rapid Strike Style": "Fighting/Water"}],
    "Calyrex": [898, {"Ice Rider": "Psychic/Ice",
...
for index, i in enumerate(pokemon):
    if inp == pokemon[i][0]:    # -WHERE
        ...
        elif pokeys[810-1] <= pokeys[index] <= pokeys[905-1]:
            print("Generation VIII")
        elif pokeys[906-1] <= pokeys[index] <= pokeys[1025-1]:
            print("Generation IX")
        ...
        try:
            if pokeys[int(inp) - 1] in Gen1_keys:    # --Generations
                ...
                print("Generation VII")
            elif pokeys[int(inp) - 1] in Gen8_keys:
                print("Generation VIII")
            elif pokeys[int(inp) - 1] in Gen9_keys:
                print("Generation IX")
        except IndexError:
