...
A2codes = {'AF': ['Afghanistan', 'AFG', '.af'],
           ...
           'MP': ['Northern Mariana Islands', 'MNP', '.mp'],
           'NO': ['Norway', 'NOR', '.no'],
           'OM': ['Oman', 'OMN', '.om'],
           'PK': ['Pakistan', 'PAK', '.pk'],
           'PW': ['Palau', 'PLW', '.pw'],
...
A3codes = {'AFG': ['Afghanistan', 'AF', '.af'],
           ...
           'MCO': ["Monaco", 'MC', '.mc'],
           'MNG': ['Mongolia', 'MN', '.mn'],
           'MNE': ['Montenegro', 'ME', '.me'],
           'MSR': ['Montserrat', 'MS', '.ms'],
           'MAR': ['Morocco', 'MA', '.ma'],
           ...
           'MKD': ['North Macedonia', 'MK', '.mk'],
           'MNP': ['Northern Mariana Islands', 'MP', '.mp'],
           'NOR': ['Norway', 'NO', '.no'],
           'OMN': ['Oman', 'OM', '.om'],
           'PAK': ['Pakistan', 'PK', '.pk'],
           'PLW': ['Palau', 'PW', '.pw'],
           'PSE': ['Palestine', 'PS', '.ps'],
           'PAN': ['Panama', 'PA', '.pa'],
           'PNG': ['Papua New Guinea', 'PG', '.pg'],
           'PRY': ['Paraguay', 'PY', '.py'],
           'PER': ['Peru', 'PE', '.pe'],
           'PHL': ['Philippines', 'PH', '.ph'],
           'PCN': ['Pitcairn', 'PN', '.pn'],
           'POL': ['Poland', 'PL', '.pl'],
           'PRT': ['Portugal', 'PT', '.pt'],
           'PRI': ['Puerto Rico', 'PR', '.pr'],
           'QAT': ['Qatar', 'QA', '.qa'],
           'REU': ['Réunion', 'RE', '.re'],
           'ROU': ['Romania', 'RO', '.ro'],
           'RUS': ['Russia', 'RU', '.ru'],
           'RWA': ['Rwanda', 'RW', '.rw'],
           'BLM': ['Saint Barthélemy', 'BL', '.bl'],
           'SHN': ['Saint Helena, Ascension and Tristan da Cunha', 'SH', '.sh'],
           'KNA': ['Saint Kitts and Nevis', 'KN', '.kn'],
           'LCA': ['Saint Lucia', 'LC', '.lc'],
           'MAF': ['Saint Martin', 'MF', '.mf'],
           'SPM': ['Saint Pierre and Miquelon', 'PM', '.pm'],
           'VCT': ['Saint Vincent and the Grenadines', 'VC', '.vc'],
           'WSM': ['Samoa', 'WS', '.ws'],
           'SMR': ['San Marino', 'SM', '.sm'],
           'STP': ['Sao Tome and Principe', 'ST', '.st'],
           'SAU': ['Saudi Arabia', 'SA', '.sa'],
           'SEN': ['Senegal', 'SN', '.sn'],
           'SRB': ['Serbia', 'RS', '.rs'],
           'SYC': ['Seychelles', 'SC', '.sc'],
           'SLE': ['Sierra Leone', 'SL', '.sl'],
           'SGP': ['Singapore', 'SG', '.sg'],
           'SXM': ['Sint Maarten', 'SX', '.sx'],
           'SVK': ['Slovakia', 'SK', '.sk'],
           'SVN': ['Slovenia', 'SI', '.si'],
           'SLB': ['Solomon Islands', 'SB', '.sb'],
           'SOM': ['Somalia', 'SO', '.so'],
           'ZAF': ['South Africa', 'ZA', '.za'],
           'SGS': ['South Georgia and the South Sandwich Islands', 'GS', '.gs'],
           'SSD': ['South Sudan', 'SS', '.ss'],
           'ESP': ['Spain', 'ES', '.es'],
           'LKA': ['Sri Lanka', 'LK', '.lk'],
           'SDN': ['Sudan', 'SD', '.sd'],
           'SUR': ['Suriname', 'SR', '.sr'],
           'SJM': ['Svalbard and Jan Mayen', 'SJ', '.sj'],
           'SWE': ['Sweden', 'SE', '.se'],
           'CHE': ['Switzerland', 'CH', '.ch'],
           'SYR': ['Syria', 'SY', '.sy'],
           'TWN': ['Taiwan', 'TW', '.tw'],
           'TJK': ['Tajikistan', 'TJ', '.tj'],
           'TZA': ['Tanzania', 'TZ', '.tz'],
           'THA': ['Thailand', 'TH', '.th'],
           'TLS': ['Timor-Leste', 'TL', '.tl'],
           'TGO': ['Togo', 'TG', '.tg'],
           'TKL': ['Tokelau', 'TK', '.tk'],
           'TON': ['Tonga', 'TO', '.to'],
           "TTO": ["Trinidad and Tobago", "TT", ".tt"],
           "TUN": ["Tunisia", "TN", ".tn"],
           "TUR": ["Turkey (Türkiye)", "TR", ".tr"],
           "TKM": ["Turkmenistan", "TM", ".tm"],
           "TCA": ["Turks and Caicos Islands", "TC", ".tc"],
           "TUV": ["Tuvalu", "TV", ".tv"],
           "UGA": ["Uganda", "UG", ".ug"],
           "UKR": ["Ukraine", "UA", ".ua"],
           "ARE": ["United Arab Emirates", "AE", ".ae"],
           "GBR": ["United Kingdom", "GB", ".gb"],
           "UMI": ["United States Minor Outlying Islands", "UM", ".um"],
           "USA": ["United States of America", "US", ".us"],
           "URY": ["Uruguay", "UY", ".uy"],
           "UZB": ["Uzbekistan", "UZ", ".uz"],
           "VUT": ["Vanuatu", "VU", ".vu"],
           "VEN": ["Venezuela", "VE", ".ve"],
           "VNM": ["Viet Nam", "VN", ".vn"],
           "VGB": ["Virgin Islands (British)", "VG", ".vg"],
           "VIR": ["Virgin Islands (U.S.)", "VI", ".vi"],
           "WLF": ["Wallis and Futuna", "WF", ".wf"],
           "ESH": ["Western Sahara", "EH", ".eh"],
           "YEM": ["Yemen", "YE", ".ye"],
           "ZMB": ["Zambia", "ZM", ".zm"],
           "ZWE": ["Zimbabwe", "ZW", ".zw"]
           }
